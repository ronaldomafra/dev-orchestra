...
Trello é o primeiro Task Source. Codex app-server + codex queue é o primeiro transporte validado. São adapters do processo, não o processo inteiro.
...
O POC valida o canal entre sessões Codex. Trello, AI Memory e QA fazem parte do fluxo proposto, mas sua integração completa é uma etapa separada.
